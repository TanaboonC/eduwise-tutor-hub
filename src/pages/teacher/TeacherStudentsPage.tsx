...
import { Search, MessageSquare, Users, Calendar, CheckCircle, BarChart3, BookOpen, ChevronRight, ClipboardCheck, Edit, Save, X } from "lucide-react";
...
// Student Evaluation Tab Component
              ...
              <TableBody>
                {filteredEvaluations.map(student => (
                  <TableRow key={student.id}>
                    ...
                    <TableCell className="text-center">
                      <div className={`w-5 h-5 rounded-full mx-auto ${getEvalStatusColor(student.overallStatus)}`}></div>
                    </TableCell>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-4 h-4 rounded-full ${getEvalStatusColor(selectedStudent?.overallStatus || "")}`}></div>
